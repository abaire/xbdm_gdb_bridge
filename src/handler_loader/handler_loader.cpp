...
// The bundled dynamic_dxt_laoder dll
extern char dyndxt_loader_start[] asm(
    "_binary__mnt_linux_data_development_xbox_xbdm_gdb_bridge_cmake_build_"
    "debug_ddxt_bin_libdynamic_dxt_loader_dll_start");
extern char dyndxt_loader_end[] asm(
    "_binary__mnt_linux_data_development_xbox_xbdm_gdb_bridge_cmake_build_"
    "debug_ddxt_bin_libdynamic_dxt_loader_dll_end");
...
uint32_t HandlerLoader::InstallDynamicDXTLoader(
  ...
  auto stream = std::make_shared<boost::interprocess::bufferstream>(
      dyndxt_loader_start, dyndxt_loader_end - dyndxt_loader_start);
