...
struct DebuggerCommandLaunch : Command {
  DebuggerCommandLaunch() : Command(
                                "<path_to_xbe> [commandline_args]\n"
                                "\n"
                                "Launches the given path, passing any remaining parameters as launch args."
                                ) {}
...
struct DebuggerCommandLaunchWait : Command {
  DebuggerCommandLaunchWait() : Command(
      "<path_to_xbe> [commandline_args]\n"
      "\n"
      "Launches the given path, passing any remaining parameters as launch args.\n"
                                    "A breakpoint will be set on the XBE entrypoint and execution will wait for a `go` command."
  ) {}
  Result operator()(XBOXInterface &interface, const std::vector<std::string> &) override {
    // TODO: Implement me.
    return Result::EXIT_REQUESTED;
...
struct DebuggerCommandRestart : Command {
  DebuggerCommandRestart() : Command(
      "\n"
      "Restarts the currently running process and breaks at the entrypoint."
  ) {}
  Result operator()(XBOXInterface &interface, const std::vector<std::string> &) override {
    // TODO: Implement me.
    return Result::EXIT_REQUESTED;
...
struct DebuggerCommandSetActiveThread : Command {
  DebuggerCommandSetActiveThread() : Command(
                                         "<thread_id>"
      "\n"
...
struct DebuggerCommandStepInstruction : Command {
  DebuggerCommandStepInstruction() : Command(
      "\n"
...
struct DebuggerCommandStepFunction : Command {
  DebuggerCommandStepFunction() : Command(
      "\n"
...
struct DebuggerCommandGetThreads : Command {
  DebuggerCommandGetThreads() : Command(
      "\n"
...
struct DebuggerCommandGetThreadInfo : Command {
  DebuggerCommandGetThreadInfo() : Command(
      "\n"
...
struct DebuggerCommandGetContext : Command {
  DebuggerCommandGetContext() : Command(
      "\n"
...
struct DebuggerCommandGetFullContext : Command {
  DebuggerCommandGetFullContext() : Command(
      "\n"
...
struct DebuggerCommandHaltAll : Command {
  DebuggerCommandHaltAll() : Command(
      "\n"
      "Halts all threads."
  ) {}
  Result operator()(XBOXInterface &interface, const std::vector<std::string> &) override {
...
struct DebuggerCommandContinueAll : Command {
  DebuggerCommandContinueAll() : Command(
...
struct DebuggerCommandContinue : Command {
  DebuggerCommandContinue() : Command(
      "[no_break_on_exceptions]\n"
      "\n"
...
struct DebuggerCommandSuspend : Command {
  DebuggerCommandSuspend() : Command(
      "\n"
